...
[`@aws-sdk/client-resource-groups-tagging-api`](https://www.npmjs.com/package/@aws-sdk/client-resource-groups-tagging-api/v/3.1122.0).
...
- @aws-sdk/client-resource-groups-tagging-api v3.1122.0 - [https://cloud-sdk-builds.github.io/?sdk=client-resource-groups-tagging-api&version=3.1122.0](https://cloud-sdk-builds.github.io/?sdk=client-resource-groups-tagging-api&version=3.1122.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.1122.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oh8i3lhmaPlEPTGFOvKY6IMEat8BTTDiLf60hR74I1V/Xv3TrwycjtQpx6k3+lAb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-resource-groups-tagging-api": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.1122.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.1122.0/index.min.mjs": "sha384-oh8i3lhmaPlEPTGFOvKY6IMEat8BTTDiLf60hR74I1V/Xv3TrwycjtQpx6k3+lAb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-resource-groups-tagging-api/blob/refs/tags/3.1122.0/LICENSE
```
