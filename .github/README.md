...
[`@aws-sdk/client-resource-groups-tagging-api`](https://www.npmjs.com/package/@aws-sdk/client-resource-groups-tagging-api/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SlwOEk+tR8/dgdKPJz9KJ2NdPtYx+scnRZvx7aw31EZzJqvZC8NQfPdWVAF/eOuw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-resource-groups-tagging-api": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.204.0/index.min.mjs": "sha384-SlwOEk+tR8/dgdKPJz9KJ2NdPtYx+scnRZvx7aw31EZzJqvZC8NQfPdWVAF/eOuw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-resource-groups-tagging-api/blob/refs/tags/3.204.0/LICENSE
```
