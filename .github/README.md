...
[`@aws-sdk/client-resource-groups-tagging-api`](https://www.npmjs.com/package/@aws-sdk/client-resource-groups-tagging-api/v/3.1059.0).
...
- @aws-sdk/client-resource-groups-tagging-api v3.1059.0 - [https://cloud-sdk-builds.github.io/?sdk=client-resource-groups-tagging-api&version=3.1059.0](https://cloud-sdk-builds.github.io/?sdk=client-resource-groups-tagging-api&version=3.1059.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.1059.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bcbSZ2IcmAnGSTwDaYIHTrsR95P5gl7RZHCx+UcZ/XLZ6H6SBXVXXjI+HDqCwiof
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-resource-groups-tagging-api": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.1059.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.1059.0/index.min.mjs": "sha384-bcbSZ2IcmAnGSTwDaYIHTrsR95P5gl7RZHCx+UcZ/XLZ6H6SBXVXXjI+HDqCwiof"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-resource-groups-tagging-api/blob/refs/tags/3.1059.0/LICENSE
```
