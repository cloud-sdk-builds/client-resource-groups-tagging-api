...
[`@aws-sdk/client-resource-groups-tagging-api`](https://www.npmjs.com/package/@aws-sdk/client-resource-groups-tagging-api/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8/zY5pkyP1T3540+R60diL92qmaZP7G+sxjWLCNO+8LIkVHXIU2OsDpRE0q3G6fy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-resource-groups-tagging-api": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.109.0/index.min.mjs": "sha384-8/zY5pkyP1T3540+R60diL92qmaZP7G+sxjWLCNO+8LIkVHXIU2OsDpRE0q3G6fy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-resource-groups-tagging-api/blob/refs/tags/3.109.0/LICENSE
```
