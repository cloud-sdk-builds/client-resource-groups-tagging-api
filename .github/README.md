...
[`@aws-sdk/client-resource-groups-tagging-api`](https://www.npmjs.com/package/@aws-sdk/client-resource-groups-tagging-api/v/3.1103.0).
...
- @aws-sdk/client-resource-groups-tagging-api v3.1103.0 - [https://cloud-sdk-builds.github.io/?sdk=client-resource-groups-tagging-api&version=3.1103.0](https://cloud-sdk-builds.github.io/?sdk=client-resource-groups-tagging-api&version=3.1103.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.1103.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-14BN/Iw/02mRjHcR8OsVfYaloC9GTptM6tMS1XmoUI3+RmfC5XoY0xcKDaiQqPqy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-resource-groups-tagging-api": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.1103.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-resource-groups-tagging-api@3.1103.0/index.min.mjs": "sha384-14BN/Iw/02mRjHcR8OsVfYaloC9GTptM6tMS1XmoUI3+RmfC5XoY0xcKDaiQqPqy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-resource-groups-tagging-api/blob/refs/tags/3.1103.0/LICENSE
```
